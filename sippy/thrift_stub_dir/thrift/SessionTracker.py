...
class Client(Iface):
  ...
  def send_b2bua_stopped(self, b2bua_id, rtime):
    self._oprot.writeMessageBegin('b2bua_stopped', TMessageType.ONEWAY, self._seqid)
  ...
  def send_call_error(self, parent_i_call, i_account, cli, cld, cost, call_id, setup_ts, remote_ip, cli_orig, cld_orig, user_agent, result, lrn_cld_in, lrn_cld, p_asserted_id, i_call_type, buying_dcg, remote_party_id):
    self._oprot.writeMessageBegin('call_error', TMessageType.ONEWAY, self._seqid)
  ...
  def send_sess_started(self, sess_id, rtime, crtime_ext, p1xx_ts):
    self._oprot.writeMessageBegin('sess_started', TMessageType.ONEWAY, self._seqid)
  ...
  def send_write_cdr(self, i_account, duration, delay, pdd1xx, connected, account_billables, accessibility_billables, customer_billables, rtime, origin, result, i_billing_plan, i_call, remote_ip, cld, cli_orig, cld_orig, setup_ts, user_agent, i_protocol, translation_cost, dcg, is_late_dcg, billing_plan_suspended, lrn_cld_in, lrn_cld, round_up, p_asserted_id, buying_dcg, remote_party_id, sdp_list, customer_dcgs):
    self._oprot.writeMessageBegin('write_cdr', TMessageType.ONEWAY, self._seqid)
    args = write_cdr_args()
    args.i_account = i_account
...
class Processor(Iface, TProcessor):
  ...
  def process_next_i_call(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("next_i_call", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_current_i_call(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("current_i_call", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_next_i_cdrs_connection(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("next_i_cdrs_connection", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_register_b2bua(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("register_b2bua", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_register_call(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("register_call", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_register_virtual(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("register_virtual", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_stats_all(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("stats_all", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_stats_total(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("stats_total", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_sess_ended(self, seqid, iprot, oprot):
    ...
    try:
      ...
      raise
    except TryBackupError as try_backup_error:
      msg_type = TMessageType.REPLY
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("sess_ended", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class b2bua_stopped_args(object):
  ...
  thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'b2bua_id', 'UTF8', None, ),  # 1
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.b2bua_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.b2bua_id is not None:
      ...
      oprot.writeString(self.b2bua_id.encode('utf-8') if sys.version_info[0] == 2 else self.b2bua_id)
      oprot.writeFieldEnd()
...
class call_error_args(object):
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'cli', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'cld', 'UTF8', None, ),  # 4
    (5, TType.DOUBLE, 'cost', None, None, ),  # 5
    (6, TType.STRING, 'call_id', 'UTF8', None, ),  # 6
    (7, TType.STRUCT, 'setup_ts', (MonoTime, MonoTime.thrift_spec), None, ),  # 7
    (8, TType.STRING, 'remote_ip', 'UTF8', None, ),  # 8
    (9, TType.STRING, 'cli_orig', 'UTF8', None, ),  # 9
    (10, TType.STRING, 'cld_orig', 'UTF8', None, ),  # 10
    (11, TType.STRING, 'user_agent', 'UTF8', None, ),  # 11
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.cli_orig = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.STRING:
          self.cld_orig = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.cli_orig is not None:
      ...
      oprot.writeString(self.cli_orig.encode('utf-8') if sys.version_info[0] == 2 else self.cli_orig)
      oprot.writeFieldEnd()
    if self.cld_orig is not None:
      oprot.writeFieldBegin('cld_orig', TType.STRING, 10)
      oprot.writeString(self.cld_orig.encode('utf-8') if sys.version_info[0] == 2 else self.cld_orig)
      oprot.writeFieldEnd()
...
class register_call_args(object):
  ...
  thrift_spec = (
    ...
    (5, TType.STRING, 'call_id', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'cld', 'UTF8', None, ),  # 6
    (7, TType.STRING, 'cli', 'UTF8', None, ),  # 7
    ...
    (13, TType.STRING, 'remote_ip', 'UTF8', None, ),  # 13
    (14, TType.STRING, 'cli_orig', 'UTF8', None, ),  # 14
    (15, TType.STRING, 'cld_orig', 'UTF8', None, ),  # 15
    (16, TType.I16, 'i_protocol', None, None, ),  # 16
    (17, TType.STRING, 'user_agent', 'UTF8', None, ),  # 17
    ...
    (25, TType.STRING, 'sess_id', 'UTF8', None, ),  # 25
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.sess_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 26:
        if ftype == TType.BOOL:
  ...
  def write(self, oprot):
    ...
    if self.sess_id is not None:
      ...
      oprot.writeString(self.sess_id.encode('utf-8') if sys.version_info[0] == 2 else self.sess_id)
      oprot.writeFieldEnd()
...
class register_virtual_args(object):
  ...
  thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'bind_session_id', 'UTF8', None, ),  # 1
    (2, TType.I64, 'i_call', None, None, ),  # 2
    (3, TType.STRING, 'remote_ip', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'cli_orig', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'cld_orig', 'UTF8', None, ),  # 5
    (6, TType.I16, 'i_protocol', None, None, ),  # 6
    (7, TType.STRING, 'user_agent', 'UTF8', None, ),  # 7
    (8, TType.I64, 'i_account', None, None, ),  # 8
    (9, TType.I64, 'i_billing_plan', None, None, ),  # 9
    (10, TType.BOOL, 'billing_plan_suspended', None, None, ),  # 10
    (11, TType.STRING, 'cld', 'UTF8', None, ),  # 11
    ...
    (17, TType.STRING, 'sess_id', 'UTF8', None, ),  # 17
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.bind_session_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    ...
    if self.bind_session_id is not None:
      ...
      oprot.writeString(self.bind_session_id.encode('utf-8') if sys.version_info[0] == 2 else self.bind_session_id)
      oprot.writeFieldEnd()
...
class stats_all_result(object):
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.I64, None, TType.LIST, (TType.I64, None, False), False), None, ),  # 0
  )
...
class sess_started_args(object):
  ...
  thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'sess_id', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'rtime', (MonoTime, MonoTime.thrift_spec), None, ),  # 2
...
class write_cdr_args(object):
  ...
  thrift_spec = (
    ...
    (8, TType.LIST, 'customer_billables', (TType.STRUCT, (CustomerBillables, CustomerBillables.thrift_spec), False), None, ),  # 8
    ...
    (14, TType.STRING, 'remote_ip', 'UTF8', None, ),  # 14
    (15, TType.STRING, 'cld', 'UTF8', None, ),  # 15
    (16, TType.STRING, 'cli_orig', 'UTF8', None, ),  # 16
    (17, TType.STRING, 'cld_orig', 'UTF8', None, ),  # 17
    (18, TType.STRUCT, 'setup_ts', (MonoTime, MonoTime.thrift_spec), None, ),  # 18
    (19, TType.STRING, 'user_agent', 'UTF8', None, ),  # 19
    ...
    (31, TType.LIST, 'sdp_list', (TType.STRUCT, (CallsSdp, CallsSdp.thrift_spec), False), None, ),  # 31
    (32, TType.LIST, 'customer_dcgs', (TType.STRUCT, (CustomerDidBillables, CustomerDidBillables.thrift_spec), False), None, ),  # 32
  )
...
class sess_ended_args(object):
  ...
  thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'b2bua_id', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'sess_id', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'customer_billables', (TType.STRUCT, (CustomerBillables, CustomerBillables.thrift_spec), False), None, ),  # 3
    ...
    (9, TType.STRING, 'origin', 'UTF8', None, ),  # 9
    ...
    (14, TType.LIST, 'sdp_list', (TType.STRUCT, (CallsSdp, CallsSdp.thrift_spec), False), None, ),  # 14
    (15, TType.LIST, 'customer_dcgs', (TType.STRUCT, (CustomerDidBillables, CustomerDidBillables.thrift_spec), False), None, ),  # 15
  )
