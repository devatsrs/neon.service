...
INSERT INTO `tblGateway` (`GatewayID`, `Title`, `Name`, `Status`, `CreatedBy`, `created_at`, `ModifiedBy`, `updated_at`) VALUES (null, 'FTP', 'FTP', 1, 'RateManagementSystem', NOW(), NULL, NOW());

INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'User Name', 'username', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'Rate Format', 'RateFormat', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'Authentication Rule', 'NameFormat', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'CDR ReRate', 'RateCDR', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'CLI Translation Rule', 'CLITranslationRule', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'FTP Host IP', 'host', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'Password', 'password', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'FTP CDR Download Path', 'cdr_folder', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'CLD Translation Rule', 'CLDTranslationRule', 1, NOW(), 'RateManagementSystem', NULL, NULL);
INSERT INTO `tblGatewayConfig` (`GatewayConfigID`, `GatewayID`, `Title`, `Name`, `Status`, `Created_at`, `CreatedBy`, `updated_at`, `ModifiedBy`) VALUES (null, (SELECT GatewayID FROM tblGateway WHERE Title='FTP' LIMIT 1), 'Billing Time', 'BillingTime', 1, NOW(), 'RateManagementSystem', NULL, NULL);

INSERT INTO `tblCompanyConfiguration` (`CompanyConfigurationID`, `CompanyID`, `Key`, `Value`) VALUES (NULL, 1, 'FTPFILE_LOCATION', '/var/www/html/neon-service-branch/dev-mysql/abubakar/storage/logs/en');
INSERT INTO `tblCronJobCommand` (`CronJobCommandID`, `CompanyID`, `GatewayID`, `Title`, `Command`, `Settings`, `Status`, `created_at`, `created_by`) VALUES (null, 1, (SELECT GatewayID FROM tblGateway WHERE Name='FTP' LIMIT 1), 'Download FTP CDR', 'ftpaccountusage', '[[{"title":"Files Max Proccess","type":"text","value":"","name":"FilesMaxProccess"},{"title":"Threshold Time (Minute)","type":"text","value":"","name":"ThresholdTime"},{"title":"Success Email","type":"text","value":"","name":"SuccessEmail"},{"title":"Error Email","type":"text","value":"","name":"ErrorEmail"}]]', 1, NOW(), 'RateManagementSystem');
INSERT INTO `tblCronJobCommand` (`CronJobCommandID`, `CompanyID`, `GatewayID`, `Title`, `Command`, `Settings`, `Status`, `created_at`, `created_by`) VALUES (null, 1, (SELECT GatewayID FROM tblGateway WHERE Name='FTP' LIMIT 1), 'Download FTP File', 'ftpdownloadcdr', '[[{"title":"Max File Download Limit","type":"text","value":"","name":"FilesDownloadLimit"},{"title":"Threshold Time (Minute)","type":"text","value":"","name":"ThresholdTime"},{"title":"Success Email","type":"text","value":"","name":"SuccessEmail"},{"title":"Error Email","type":"text","value":"","name":"ErrorEmail"}]]', 1, NOW(), 'RateManagementSystem');
