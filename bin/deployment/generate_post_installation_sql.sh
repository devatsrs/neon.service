...
sed -i "s/_UPLOAD_PATH_/$(echo "$UPLOAD_PATH" | sed 's/\//\\\//g')/g" ${POST_INSTALLATION_SQL_SCRIPT}
sed -i "s/_TEMP_PATH_/$(echo "$TEMP_PATH" | sed 's/\//\\\//g')/g" ${POST_INSTALLATION_SQL_SCRIPT}

sed -i "s/_FRONT_STORAGE_PATH_/$(echo "$FRONT_STORAGE_PATH" | sed 's/\//\\\//g')/g" ${POST_INSTALLATION_SQL_SCRIPT}
...
sed -i "s/_EMAIL_TO_CUSTOMER_/$(echo "$EMAIL_TO_CUSTOMER" | sed 's/\//\\\//g')/g" ${POST_INSTALLATION_SQL_SCRIPT}
