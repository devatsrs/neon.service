...
COMPANY=wholesaledemo
#Real Company Name
DB_COMPANY_NAME="Wholesale Demo"
...
#Licence key
LICENCE_KEY=Yp5wE8jd7YExP2CIAUFpf5NMgvQCZ4U8
#Temp path for document upload and cdrs.
TEMP_PATH=/home/hostedfolders/wholesaledemo/tmp
#DB host ip or name
DB_HOST=localhost
#DB host username
...
#Web URL
WEB_URL=${HOST_DOMAIN_URL}/${WEB_FOLDER_NAME}/public
#Service location
