...
COMPANY=WavetelRelease
#Real Company Name
DB_COMPANY_NAME="Wavetel Release"
...
#Licence key
LICENCE_KEY=qWyHV5PYz3JGnp6gxMoiKu5o5cvhyL6O
#Temp path for document upload and cdrs.
TEMP_PATH=/home/release/tmp
#DB host ip or name
DB_HOST=localhost
#DB host username
