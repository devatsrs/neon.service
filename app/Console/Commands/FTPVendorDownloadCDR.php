...
class FTPVendorDownloadCDR extends Command {
     ...
     * @var string
     */
    protected $name = 'ftpvendordownloadcdr';
    ...
    public function handle()
    {
        ...
        Log::useFiles(storage_path().'/logs/ftpvendordownloadcdr-'.$CompanyGatewayID.'-'.date('Y-m-d').'.log');
        ...
        try {
            ...
            $ftp = new FTPVendorGateway($CompanyGatewayID);
            ...
            Log::info('vendor ftp File download Count '.count($filenames));
            $downloaded = array();
