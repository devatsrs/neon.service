...
class PortaVendorSheet extends Command {
    ...
    public function handle()
    {
        ...
        try{
            ...
            Log::info("CALL  prc_CronJobGeneratePortaVendorSheet ('" .$job->AccountID . "','" . $tunkids."','".$Effective."','".$CustomDate."')");
            $excel_data = DB::select("CALL  prc_CronJobGeneratePortaVendorSheet ('" .$job->AccountID . "','" . $tunkids."','".$Effective."','".$CustomDate."')");
