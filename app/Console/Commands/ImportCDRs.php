			...
			if (!empty($job)) {
				...
				if ($jobfile->FilePath) {
					...
					foreach ($results as $temp_row) {
                        ...
                        $row_data['connect_time'] = trim($temp_row['connect_time']);
                        $row_data['disconnect_time'] = trim($temp_row['disconnect_time']);
                        $row_data['billed_duration'] = trim($temp_row['billed_duration']);
                        $row_data['Duration'] = trim($temp_row['billed_second']);
                        $row_data['CLI'] = trim($temp_row['cli']);
                        $row_data['CLD'] = trim($temp_row['cld']);
                        $row_data['is_inbound'] = trim($temp_row['is_inbound']);
