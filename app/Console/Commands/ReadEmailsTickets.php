	...
	{		
		...
		foreach ($tickets as $ticket)
		{
			if($ticket->EscalationEmail==1 && $ticket->IsRespondedVoilation==1){
				new	TicketEmails(array("TicketID"=>$ticket->TicketID,"CompanyID"=>$CompanyID,"RespondTime"=>$ticket->RespondTime,"TriggerType"=>array("AgentResponseSlaVoilation")));
			}
			
			if($ticket->EscalationEmail==1 && $ticket->IsResolvedVoilation==1){
				new	TicketEmails(array("TicketID"=>$ticket->TicketID,"CompanyID"=>$CompanyID,"ResolveTime"=>$ticket->ResolveTime,"TriggerType"=>array("AgentResolveSlaVoilation")));
			}						
		}		
	}
}