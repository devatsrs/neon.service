...
class CronHelper {
    ...
    public static function get_command_file_name($Cron) {

        $arguments = $Cron->argument();
        $lock_command_file =  $Cron->name;
    ...
    public static function before_cronrun($Cron) {

        $lock_command_file = self::get_command_file_name($Cron);
    ...
    public static function after_cronrun($Cron) {
