    ...
    function xmlSerialize(Writer $writer) {
        ...
        $writer->write([
            [
                ...
                'value' => number_format((float)$this->lineExtensionAmount, 2, '.', ''),
                'attributes' => [
            ...
            [
                ...
                'value' => number_format((float)$this->taxExclusiveAmount, 2, '.', ''),
                'attributes' => [
                    'currencyID' => Generator::$currencyID
                ]
            ...
            [
                ...
                'value' => number_format((float)$this->taxInclusiveAmount, 2, '.', ''),
                'attributes' => [
                    'currencyID' => Generator::$currencyID
                ]
            ...
            [
                ...
                'value' => number_format((float)$this->allowanceTotalAmount, 2, '.', ''),
                'attributes' => [
                    'currencyID' => Generator::$currencyID
                ]
            ...
            [
                ...
                'value' => number_format((float)$this->payableAmount, 2, '.', ''),
                'attributes' => [
                    'currencyID' => Generator::$currencyID
                ]
